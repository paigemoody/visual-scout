...
def inspect_video(video_file):
    ...
    This function retrieves and displays essential metadata of a video file, 
...
def extract_frames_from_directory(input_dir):
    ...
    saved in corresponding subdirectories within the specified output directory.
...
# Example 
# extract_frames_from_directory("visual_scout/example_videos")
