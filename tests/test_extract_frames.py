...
class TestExtractFrames(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # self.valid_output_dir = os.path.join("output", "output_frames", f"{base_name}__frames")
        # self.invalid_output_dir = os.path.join("output", "output_frames", "invalid_video__frames")
    ...
    def test_extract_frames_invalid_video(self):
        ...
        invalid_video_file = os.path.join(self.test_input_dir, "invalid_video.mov")
    ...
    #     valid_output_dir1 = os.path.join(os.getcwd(), "output", "output_frames", f"{base_name1}__frames")
    #     valid_output_dir2 = os.path.join(os.getcwd(), "output", "output_frames", f"{base_name2}__frames")
    ...
    #     non_video_output_dir = os.path.join("output","","random__frames")
